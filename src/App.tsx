    ...
    <div className={`app-container ${isFloatingMode ? 'transparent-bg' : ''}`}>
      ...
      <div className="app-main">
        ...
        <section className={`eve-section ${isFloatingMode ? 'floating-widget' : ''} ${isListening || isSpeaking || isSending ? 'eve-active' : ''}`}>
          ...
          {/* Rendu Canvas 3D */}
          <div style={{ flex: isFloatingMode ? 'none' : 1, height: isFloatingMode ? '360px' : 'auto', width: '100%', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: isFloatingMode ? '34px' : '0' }}>
            <ThreeCanvas
              emotion={currentEmotion}
