...
[![Version](https://img.shields.io/badge/version-1.0.5-brightgreen.svg?style=flat-square)](https://github.com/R0m1k3/EveFlow/releases/tag/v1.0.5)
...
2. **Générer le package d'installation Windows** :
   ...
   npm run dist
   ```
   *L'exécutable d'installation NSIS (`EveFlow Setup 1.0.5.exe`) et la build décompressée seront générés dans le dossier `./out/`.*
